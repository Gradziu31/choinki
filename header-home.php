...
<body <?php body_class()?>>
	...
	<div class="logo_lewa_strona">
		<p class="nazwa_firmy"><b>Nazwa</b></p>
	...
	<div class="menu_boczne_lewa_strona">
				...
				<!--<a href="ru/index.html"><img src="<?php echo get_template_directory_uri(); ?>/images/ru.png" alt="..."></img></a>
				<a href="en/index.html"><img src="<?php echo get_template_directory_uri(); ?>/images/en.png" alt="..."></img></a>
				<a href="index.html"><img src="<?php echo get_template_directory_uri(); ?>/images/pl.png" alt="..."></img></a>-->
<?php echo do_shortcode('[google-translator]'); ?>
						</div>
